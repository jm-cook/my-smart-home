...
To make a dashboard like mine you will need to install [Mushroom](https://github.com/piitaya/lovelace-mushroom).
   
Follow the instructions for installing the package on your own installation.
